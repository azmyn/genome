...
#   skip = 4
# )
mut_dat = fread("/Users/azumi/Dropbox/KU/shimolab_2019/genome/kich.mut_count.txt", stringsAsFactors = FALSE, encoding = "UTF-8")
cli_dat = fread(
  "/Users/azumi/Genome/kich_tcga/data_bcr_clinical_data_patient.txt",
  stringsAsFactors = FALSE,
  encoding = "UTF-8",
  skip = 4
)
...
file.name = "kich_biplot_revised.png"
