...
#   skip = 4
# )
mut_dat = fread("/Users/azumi/Dropbox/KU/shimolab_2019/genome/cesc.mut_count.txt", stringsAsFactors = FALSE, encoding = "UTF-8")
cli_dat = fread(
  "/Users/azumi/Genome/cesc_tcga/data_bcr_clinical_data_patient.txt",
  stringsAsFactors = FALSE,
  encoding = "UTF-8",
  skip = 4
)
...
dat2 = na.omit(dat[, 1:4])

dat = dat2[c(-1,-64,-81,-87,-113,-128,-132,-134,-141,-172),] #外れ値10個
...
file.name = "cesc_biplot_revised.png"
