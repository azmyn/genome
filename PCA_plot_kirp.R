...
#   skip = 4
# )
mut_dat = fread("/Users/azumi/Dropbox/KU/shimolab_2019/genome/kirp.mut_count.txt", stringsAsFactors = FALSE, encoding = "UTF-8")
cli_dat = fread(
  "/Users/azumi/Genome/kirp_tcga/data_bcr_clinical_data_patient.txt",
  stringsAsFactors = FALSE,
  encoding = "UTF-8",
  skip = 4
)
...
file.name = "kirp_biplot_revised.png"
