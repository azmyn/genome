...
#   skip = 4
# )
mut_dat = fread("/Users/azumi/Dropbox/KU/shimolab_2019/genome/blca.mut_count.txt", stringsAsFactors = FALSE, encoding = "UTF-8")
cli_dat = fread(
  "/Users/azumi/Genome/blca_tcga/data_bcr_clinical_data_patient.txt",
  stringsAsFactors = FALSE,
  encoding = "UTF-8",
  skip = 4
)
...
dat = dat2[c(-90,-114,-290,-362),] #外れ値4個
...
file.name = "blca_biplot_revised.png"
