...
#   skip = 4
# )
mut_dat = fread("/Users/azumi/Dropbox/KU/shimolab_2019/genome/hnsc.mut_count.txt", stringsAsFactors = FALSE, encoding = "UTF-8")
cli_dat = fread(
...
dat = dat2[c(-52,-213,-310,-339,-346,-386,-474),] #外れ値10個
...
file.name = "hnsc_biplot_revised.png"
